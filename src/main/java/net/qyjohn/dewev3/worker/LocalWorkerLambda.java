...
public class LocalWorkerLambda extends Thread
{
	// Common components
	...
	// Logging
	final static Logger logger = Logger.getLogger(LocalWorkerLambda.class);
	...
	public LocalWorkerLambda(String longStream, boolean cleanUp)
	{
		try
		{
